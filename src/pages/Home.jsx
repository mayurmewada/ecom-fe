            ...
            <section className="container !mt-[44px]">
                ...
                <div className="flex gap-4">
                    {data?.categories?.map((category, idx) => (
                        <div key={`${category}${idx}`} onClick={() => navigate({ pathname: `/products`, search: `?category=${category}` })} className="relative w-1/5 border border-gray-100 hover:border-grey-200 cursor-pointer px-4 pt-7 pb-4 flex flex-col items-center gap-6">
