                        ...
                        {filter.values.map((filterValue) => (
                            <li className="py-1">
                                <button className="py-1 flex gap-3 w-full relative">
                                    ...
                                    <Checkbox name={filterValue.selector} checked={getChecked(filter.name, filterValue.selector)} className="group block pointer-events-none min-w-[18px] min-h-[18px] max-w-[18px] max-h-[18px] rounded border bg-white data-[checked]:bg-blue-500">
