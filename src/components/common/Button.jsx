...
const Button = ({ title=null, viewType=null, variant, size, isDisabled, type, onClick, leadingIcon = null, trailingIcon = null }) => {
    const styles = {
    ...
    return (
        <button className={`flex justify-center items-center gap-x-[6px] ${styles[variant]} ${styles[size]}${viewType === "icon" ? " !px-2" : " font-semibold"}`} onClick={onClick} type={type} disabled={isDisabled}>
